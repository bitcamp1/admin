...
<ul class='tabs'>   
	...
	<li><a href='#tab3' >추가차감현황</a></li>
     ...
     <div >
     	<div id='tab1' class='tab_ctn'><%@ include file="../rebate/frame/main.jsp"%></div>
     	<div id='tab2' class='tab_ctn'><%@ include file="../commission/frame/main.jsp"%></div>
     	<div id='tab3' class='tab_ctn'><%@ include file="../deduction/frame/main.jsp"%></div>
     </div>
